...
public class TextJoiner {
  ...
  public String join(String text1, String text2) {
    ...
    // Discard a one-character overlap if it doesn't start at index 0.
    ...
    if (bestOverlap.length > 0) {
      ...
      return s1 + s2.substring(joinIndexInS2);
    } else {
  ...
  // Normalize a string by removing all whitespace and converting to lower case.
